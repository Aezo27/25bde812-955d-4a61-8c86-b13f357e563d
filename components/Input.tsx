  ...
  return (
    <>
      ...
      <input
        ...
        id={name}
        value={setValue}
        className={`block w-full p-2 mt-2 text-gray-700 bg-white dark:bg-gray-800 border  ${error ? "border-red-500 dark:border-red-400 focus:ring-red-400 dark:focus:ring-red-300 focus:border-red-400 dark:focus:border-red-300" : "border-gray-400 dark:border-gray-600 focus:ring-blue-300 dark:focus:ring-gray-500 focus:border-blue-400 dark:focus:border-gray-700" 
