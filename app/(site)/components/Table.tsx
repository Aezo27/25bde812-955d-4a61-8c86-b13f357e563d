...
const Table: React.FC<TableProps> = ({ products, total }) => {
  return (
    <div data-testid="table" className="flex flex-col mt-6">
      <div className="inline-block min-w-full py-2 align-middle">
        <div className="overflow-auto border border-gray-200 dark:border-gray-600 md:rounded-lg">
