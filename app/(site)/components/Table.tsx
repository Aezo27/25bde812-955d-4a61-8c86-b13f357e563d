...
const ProductTable: React.FC<TableProps> = ({ products }) => {
  ...
  return (
    <div className="flex flex-col mt-6">
                    ...
                    <div className="flex justify-end gap-2">
                      <button
                        ...
                        <svg className="w-5" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path d="M7 9C8.10457 9 9 8.10457 9 7C9 5.89543 8.10457 5 7 5C5.89543 5 5 5.89543 5 7C5 8.10457 5.89543 9 7 9Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                      </button>
                      <button
                        onClick={() => { view(item.id) }}
                      ...
                      <button
                        onClick={() => { setIsDelete([item.title ,item.id, true]) }}
      ...
      {isView &&
        <View product={product} setIsView={setIsView}/>
      }
    </div>
  );
};
